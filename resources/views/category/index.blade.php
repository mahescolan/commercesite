							...
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right notification">
										...
										<li class="notification">
											<div class="media">
												...
												<div class="media-body">
													<p><strong>{{$item->id}}</strong><span class="n-time text-muted"><i class="icon feather icon-clock m-r-10"></i>5 min</span></p>
									...
									<div class="noti-footer">
										<a  href="{{ route('orderManage') }}"  class="btn btn-outline-primary" >show all</a>
									</div>
									@endif
								</div>
							</div>
...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <main class="main">
			@can('isadmin')
            <a class="btn btn-outline-success" href="{{ route('category.create') }}"> Create New category</a>
            <a class="btn btn-outline-secondary" href="{{ route('products.index') }}"> Products</a>
                                        ...
                                        <tr >
                                           ...
                                           <td class="action" data-title="Action">
                                            <form action="{{ route('category.destroy',$category->id) }}"  method="POST">
                                                <button class="btn btn-outline-primary"><a href="{{ route('category.show',$category->id) }}" class="text-muted">show</a></button>
												@if(optional($category->categorys)->count())
                                                <button class="btn btn-outline-info"><a href="{{ route('category.edit',$category->id) }}" class="text-muted">Edit</a></button>
												@endif
                   								 @if(!optional($category->categorys)->count())
                                                @csrf
                                                @method('DELETE')
