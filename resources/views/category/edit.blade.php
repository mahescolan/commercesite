                            ...
                            <div class="col-md-6">
                                <form action="{{ route('category.update',$category->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endif
                                        <input type="radio" id="act" name="status" value="0" @if($category->status==0)checked @endif>
                                        <label for="active"><h6>Active</h6></label><br>
                                        <input type="radio" id="inact" name="status" value="1" @if($category->status==1)checked @endif>
