                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info">
                                    ...
                                    <div class="detail-extralink">
                                        ...
                                        <div class="product-extra-link2">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="{{ route('cart.store', ['id' => $products->id]) }}"><i class="fi-rs-shopping-bag-add"></i></a>
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up" href="wishlist.php"><i class="fi-rs-heart"></i></a>
                                            <a aria-label="Compare" class="action-btn hover-up" href="compare.php"><i class="fi-rs-shuffle"></i></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                        ...
                                        <div class="product-cart-wrap small hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="product-details.html" tabindex="0">
                                                        <img class="default-img" src="{{asset('images/'.$relproduct->image)}}" alt="">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="product-details.html" tabindex="0">{{ $relproduct->name }}</a></h2>
