                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>                                
                                <i class="fi-rs-key"></i><a href="{{route('userLogin')}}">Log In </a>  / <a href="{{route('userRegister')}}">Sign Up</a>/<a href="{{route('logout')}}">log out</a>
                            </ul>
                        </div>
                    </div>
                </div>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html"><img alt="Surfside Media" src="{{asset('thumbnail/'.$product->cartsPro->image)}}"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="product-details.html">{{ $product->cartsPro->name }}</a></h4>
                                                    <h4>${{$product->cartsPro->price}}</h4>
                                                </div>
...
<section class="mt-50 mb-50">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    @foreach($products as $key=>$product)
                                    @php $total = 0 @endphp
                                    @php $total += $product->cartsPro->price * $product->product_qty  @endphp
                                   <tr>
                                        <td class="image product-thumbnail"><img src="{{asset('thumbnail/'.$product->cartsPro->image)}}" alt=""></td>

                                        <td class="product-des product-name">
                                            <h5 class="product-name"><a href="product-details.html">{{ $product->cartsPro->name }}</a></h5>
                                            <p class="font-xs">Maboriosam in a tonto nesciung eget<br> distingy magndapibus.
                                            </p>
                                        </td>
                                        <td class="price" data-title="Price"><span><b>₹</b> {{$product->cartsPro->price}}</span></td>
                                        <td class="text-center" data-title="Stock" data-th="Quantity">
                                          
                                                <input type="number"  data-product_id='{{$product->product_id}}' data-key="{{$key}}" 
                                                data-id='{{$product->cartsPro->price}}' id="cart_product_id_{{$product->cartsPro->id}}" 
                                                size="4" name='qty' class="input-text qty  text" title="Qty" value="{{$product->product_qty}}" min="1" 
                                                max='{{$product->cartsPro->Quantity}}' step="1">
                                                {{-- <a href="{{ route('cart.store',$product->id) }}" class="qty-down" onclick='return change()'><i class="fi-rs-angle-small-down"></i></a>
                                                <span class="qty-val" id="number" name="quantity">{{$product->product_qty }}</span>
                                                <a href="#" class="qty-up"  onclick='return change()'><i class="fi-rs-angle-small-up"></i></a> --}}
                                          
                                            
                                        </td>
                                        <td class="text-right" data-title="Cart">
                                            <span id ="amt_{{$key}}" class = "amt">₹{{ $product->cartsPro->price * $product->product_qty }}</span>
                                        </td>
                                        <td>
                                       
                                            {{-- <input type="hidden" value="{{ $product->id }}" name="id">
                                            <button class="px-4 py-2 text-black bg-red-600 .remove">remove</button> --}}
                                            <a title="Remove this item" data-cart_id="{{$product->id}}" class="remove" href="{{ url('remove/'.$product->id) }}"><i class="fi-rs-trash"></i></a>
                                   ...
                                   @endforeach
                                    ...
                                    {{-- <td colspan="6" class="text-end">
                                        <a href="{{ url('clear/') }}" class="text-muted"> <i class="fi-rs-cross-small"></i> Clear Cart</a>
                                    </td>
                                --}}
                                </tbody>
                            </table>
                        ...
                        <div class="cart-action text-end">
                            <a class="btn  mr-10 mb-sm-15"  href="{{ route('orderManage') }}"><i class="fi-rs-shuffle mr-10"></i>Order</a>
    ...
    <script>
        ...
        //         var product_id= $(this).attr('data-cart_id');
        //         $.ajax({
