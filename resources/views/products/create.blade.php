                            ...
                            <div class="col-md-6">
                                <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name" value="{{old('name')}}" required="">
                                        @if($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        <label for="price"><h5>Product price</h5></label>
                                        <input type="number" name="price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter price" value="{{old('price')}}" required="">
                                        @if($errors->has('price'))
                                    ...
                                    <div class="form-group">
                                        <label for="Image"><h5>Product Image</h5></label>
                                        <input type="file" name="image" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="{{old('Image')}}" required="">
                                        @if($errors->has('Image'))
									...
									<div class="form-group">
                                        ...
                                        <input type="number" name="Quantity" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="{{old('Quantity')}}" required="">
                                    ...
                                    <div class="form-group">
                                        <label for="category"><h5>catgeory_name</h5></label><br>
