                            ...
                            <div class="col-md-6">
                                <form action="{{ route('products.update',$products->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name" value="{{ $products->name }}" required="">
                                        @if($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter price" value="{{ $products->price }}" required="">
                                        @if($errors->has('price'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="image" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="" required=""><br>
                                        <img src="{{asset('thumbnail/'.$products->image)}}" width="100px"> 
                                        @if($errors->has('Image'))
									...
									<div class="form-group">
                                        ...
                                        <input type="number" name="Quantity" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  value="{{ $products->Quantity }}" required="">
									...
									<div class="form-group">
                                        ...
                                        @endif
                                        <input type="radio" id="act" name="status" value="0" @if($products->status==0)checked @endif>
                                        <label for="active"><h6>Active</h6></label><br>
                                        <input type="radio" id="inact" name="status" value="1" @if($products->status==1)checked @endif>
                                        <label for="active"><h6>Inactive</h6></label><br>
                                    </div>
                                  
                                    <div class="form-group">
                                        <label for="category">catgeory_name</label><br>
                                                <select name="category_id" id="create" class="form-control" required="">
