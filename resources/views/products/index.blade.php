				...
				<div class="collapse navbar-collapse">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li>
                            ...
                            <i class="fi-rs-key"></i><a href="{{route('adminLogin')}}">Log In </a>  / <a href="{{route('adminRegister')}}">Sign Up</a>/<a href="{{route('logout')}}">log out</a>
...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <!-- [ Main Content ] start -->
        <main class="main">
            <a class="btn btn-outline-success" href="{{ route('products.create') }}"> Create New Products</a>
            <a class="btn btn-outline-warning" href="{{ route('category.index') }}"> Category</a>
                            ...
                            <div class="table-responsive">
                                <table class="table shopping-summery text-center clean">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            <td style="color:rgb(25, 4, 248);">{{ $product->name }}</td>
                                        <td style="color:rgb(183, 4, 248);">₹{{ $product->price }}</td>
										
                                        <td><img src="{{asset('thumbnail/'.$product->image)}}" width="100px"></td>
										<td style="color:rgb(14, 14, 14);">{{ $product->Quantity }}</td>
										@if($product->status==0)
                                            <td style="color:rgb(35, 243, 7);">Active</td>
                                                @else
                                                <td style="color:rgb(243, 72, 72);">Inactive</td>
                                                @endif
                                            

                                        <td style="color:rgb(248, 4, 69);">{{optional($product->createdby)->name ? optional($product->createdby)->name:'-'}}</td>
                                        <td style="color:rgb(248, 126, 4);">{{$admin_name}}</td>
                                            
                                           <td class="action" data-title="Action">
                                            <form action="{{ route('products.destroy',$product->id) }}" method="POST">
                                                <button class="btn btn-outline-primary"><a href="{{ route('products.show',$product->id) }}" class="text-muted">show</a></button>
                                                <button class="btn btn-outline-info"><a href="{{ route('products.edit',$product->id) }}" class="text-muted">Edit</a></button>
                                                @csrf
                                                @method('DELETE')
