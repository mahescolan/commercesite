                            ...
                            <div class="col-md-6">
                                <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{asset('/images/'.$products->image)}}" width="100px"> 
                                    ...
                                    <div class="form-group">
                                        <label for="category"><h5>catgeory_name:</h5></label>
                                        {{optional($products->createdby)->name ? optional($products->createdby)->name:'-'}}
                                    </div>
                                    <div class="form-group">
                                        <label for="category"><h5>admin_name:</h5></label>
                                        {{$admin_name}}
